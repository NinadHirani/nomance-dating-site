      ...
      <div className="container mx-auto px-4">
          <div className="h-16 flex items-center">
            ...
            <div className="hidden lg:flex items-center gap-3">
              <Link href="/coach">
                <Button variant="default" size="sm" className="items-center gap-2 rounded-full bg-gradient-to-r from-purple-600 to-primary hover:opacity-90 border-none shadow-lg shadow-primary/20 font-black px-6 text-[10px] tracking-widest uppercase">
